class createTextFunction extends MouseMethods {
    ...
    onkeyDown(event) {
        ...
        if ([9, 16, 17, 18, 20, 37, 38, 39, 40, 91].indexOf(event.keyCode) !== -1) {
...
//     } else {
//         // write text
//         this.context.fillText(e.key, this.startingX, this.startingY)
//         // console.log(e.key)

//         // Move the key forward as you type
//         this.startingX += this.context.measureText(e.key).width;
//     }
// });